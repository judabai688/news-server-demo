...
public final class NewsServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<edu.zcs.news.proto.NewsProto.NewsRequest,
      edu.zcs.news.proto.NewsProto.NewsResponse> getListMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "list",
      requestType = edu.zcs.news.proto.NewsProto.NewsRequest.class,
      responseType = edu.zcs.news.proto.NewsProto.NewsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<edu.zcs.news.proto.NewsProto.NewsRequest,
      edu.zcs.news.proto.NewsProto.NewsResponse> getListMethod() {
    io.grpc.MethodDescriptor<edu.zcs.news.proto.NewsProto.NewsRequest, edu.zcs.news.proto.NewsProto.NewsResponse> getListMethod;
      ...
      synchronized (NewsServiceGrpc.class) {
        if ((getListMethod = NewsServiceGrpc.getListMethod) == null) {
          NewsServiceGrpc.getListMethod = getListMethod =
              io.grpc.MethodDescriptor.<edu.zcs.news.proto.NewsProto.NewsRequest, edu.zcs.news.proto.NewsProto.NewsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "list"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  edu.zcs.news.proto.NewsProto.NewsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  edu.zcs.news.proto.NewsProto.NewsResponse.getDefaultInstance()))
  ...
  public static abstract class NewsServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void list(edu.zcs.news.proto.NewsProto.NewsRequest request,
        io.grpc.stub.StreamObserver<edu.zcs.news.proto.NewsProto.NewsResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                edu.zcs.news.proto.NewsProto.NewsRequest,
                edu.zcs.news.proto.NewsProto.NewsResponse>(
                  this, METHODID_LIST)))
          .build();
    }
  }
  ...
  public static final class NewsServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<NewsServiceBlockingStub> {
     ...
     * </pre>
     */
    public edu.zcs.news.proto.NewsProto.NewsResponse list(edu.zcs.news.proto.NewsProto.NewsRequest request) {
  ...
  public static final class NewsServiceFutureStub extends io.grpc.stub.AbstractFutureStub<NewsServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<edu.zcs.news.proto.NewsProto.NewsResponse> list(
        edu.zcs.news.proto.NewsProto.NewsRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_LIST:
          serviceImpl.list((edu.zcs.news.proto.NewsProto.NewsRequest) request,
              (io.grpc.stub.StreamObserver<edu.zcs.news.proto.NewsProto.NewsResponse>) responseObserver);
          break;
        default:
